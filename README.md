...
- `data/three_seed/`: Raw and summarized results for the three random-seed robustness analysis.
...
- Three-seed statistics: `data/three_seed/td3_three_seed_summary.csv`
...
- Fig. 8: `figures/fig8_training_convergence.jpeg`
...
The manuscript reports a simulation-based verification using an averaged continuous-conduction-mode boost-converter model. The uploaded files include processed results and trajectory data used to generate the tables and figures in the manuscript.
